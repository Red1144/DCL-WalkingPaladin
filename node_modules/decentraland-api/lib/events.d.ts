...
export interface IEvents {
    ...
    /**
     * `changed` is triggered when an entity changes its own internal state.
     * Dispatched by the `input-text` entity when the value is changed.
     */
    changed: {
        elementId: string;
        value: any;
    ...
    /**
     * `onChanged` is triggered when an entity changes its own internal state.
