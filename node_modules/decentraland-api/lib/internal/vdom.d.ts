...
import { SubsetMapping } from './SubsetMapping';
import { Diff } from './Diff';
export declare class DiffDOM {
    options: {};
    tracker: Diff[];
    t1Orig: ISimplifiedNode | void;
    t2Orig: ISimplifiedNode | void;
    debug: boolean;
    diffcap: number;
    maxDepth: number | false;
    maxChildCount: number | false;
    maxChildCountDiffCount: number;
    filterOuterDiff: Function | null;
    compress: boolean;
    constructor(options?: {});
    ...
    attemptGroupRelocation(t1: ISimplifiedNode, t2: ISimplifiedNode, subtrees: SubsetMapping[], route: number[]): Diff[];
    ...
    getFromVirtualRoute(tree: ISimplifiedNode, route: number[]): {
        ...
        parentNode: void | ISimplifiedNode;
        nodeIndex: number;
    };
