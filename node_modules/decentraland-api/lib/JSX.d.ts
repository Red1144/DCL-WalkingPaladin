...
declare global {
    namespace JSX {
        ...
        type UITexture = BaseEntity & {
            /**
             * The id of UI texture instance
             */
            id?: string;
            /**
             * The height of the UI texture
             */
            height?: string;
            /**
             * The width of the UI texture
             */
            width?: string;
        };
        type UIContainer = BaseEntity & {
            opacity?: number;
            adaptWidth?: boolean;
            adaptHeight?: boolean;
            width?: string;
        ...
        type UIContainerRect = UIContainer & {
            thickness?: number;
            cornerRadius?: number;
        };
        type UIContainerStack = UIContainer & {
            isVertical?: boolean;
        };
        type UIText = TextEntity & {
            id?: string;
            top?: string;
            left?: string;
        };
        type UIInputText = BaseEntity & {
            color?: string;
            thickness?: number;
            fontFamily?: string;
            fontSize?: number;
            ...
            top?: string;
            left?: string;
            onChanged?: (e: IEvents['onChanged']) => void;
            onFocus?: (e: IEvents['onFocus']) => void;
            onBlur?: (e: IEvents['onBlur']) => void;
        };
        type UISlider = BaseEntity & {
            minimum?: number;
            maximum?: number;
            color?: string;
            opacity?: number;
        ...
        interface IntrinsicElements {
            ...
            ui: UITexture;
            ['ui-container-rect']: UIContainerRect;
            ['ui-container-stack']: UIContainerStack;
            ['ui-text']: UIText;
            ['ui-input']: UIInputText;
            ['ui-slider']: UISlider;
            ['ui-image']: UIImage;
            ['ui-fullscreen']: UIFullscreen;
        }
    }
}
