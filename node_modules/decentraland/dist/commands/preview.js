...
function start(vorpal) {
    vorpal
        ...
        const isCi = utils_1.getOrElse(args.options.ci, env_1.isEnvCi());
        const shouldWatchFiles = utils_1.getOrElse(args.options.watch, true) && !isCi;
        ...
        dcl.on('preview:ready', port => {
            ...
            const openBrowser = utils_1.getOrElse(args.options.browser, true) && !isCi;
            let url = null;
